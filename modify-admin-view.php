...
<body class="bg-light">
  <div class="container">
    <div class="py-5 text-center">
      <h2>Formulario de modificacion del administrador</h2>
    </div>
    <div class="col-md-12 order-md-1">
      <h4 class="mb-3">Datos del administrador</h4>
      <h5>Nota: El RFC no se puede modificar, únicamente se utilizar para checar la existencia de este usuario</h5>
      <form class="needs-validation" method="post" action="./modify-admin.php" novalidate>
        <div class="row">
          ...
          <div class="col-md-12 mb-3">
            ...
            <input type="text" class="form-control" id="name" placeholder="Ingresa tu nombre completo" name="name" required>
            <div class="invalid-feedback">
              Campo requerido
            </div>
            <div class="mb-3">
            ...
            <div class="mt-3 mb-3">
              <button class="btn btn-primary btn-lg btn-block mb-3" type="submit">Modificar administrador</button>
