...
<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
  ...
  <main role="main" class="container-fluid text-center">
    <h1 class="mb-5">Menú de administrador</h1>
    <div class="row">
        <div class="col-sm-6 mt-5 text-center">
            <a href="./signup-admin.php" class="btn btn-primary">Agregar administrador</a>
        </div>
        <div class="col-sm-6 mt-5 text-center">
            <a href="./delete-admin.php" class="btn btn-primary">Eliminar admin</a>
        </div>
        <div class="col-sm-6 mt-5 text-center">
            <a href="./show-admin.php" class="btn btn-primary">Mostrar administradores</a>
        </div>
        <div class="col-sm-6 mt-5 text-center">
            <a href="./modify-admin.php" class="btn btn-primary">Modificar administrador</a>
        </div>
    </div>
  </main>
</body>
