...
<body class="bg-light">
  <div class="container">
    ...
    <div class="col-md-12 order-md-1">
      <h4 class="mb-3">Datos del contenido a eliminar</h4>
      <form class="needs-validation" method="post" action="./content-course.php" novalidate>
        <div class="row">
            <div class="col-md-12 mb-3">
                <label>Selecciona el curso donde se eliminará el contenido</label>
                <div class="container">
                <div class="row">    
