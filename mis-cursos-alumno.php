...
<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item active">
          <a class="nav-link" href="./modify-alumno.php">Recibos de inscripciones</a>
        </li>
        <li class="nav-item active">
  ...
  <div class="container">
    ...
    <h6 class="border-bottom border-gray pb-2 mb-0 mt-5">Listado de mis cursos</h6>
    <?php 
        require './conexion.php';
        $conexion = conectar();
        if($conexion[0]) {
            $query = sprintf('call cursoInscritosAlumno("'.$_SESSION['idUsuario'].'");');
                ...
                <form class="needs-validation" method="post" action="./alumno-content-curso.php" novalidate>
                    <div class="media text-muted pt-3">
                        ...
                        <input type="hidden" class="form-control" value="'.$fila['idCurso'].' " name="id" required>
                            ...
                            <span class="d-block"> Precio (mxn): '.$fila['precioCurso'].'</span>
                            <div class="mt-3 mb-3 col-sm-12">
                                <button class="btn btn-primary btn-lg btn-block mb-3" type="submit">Ver contenido</button>
                            </div>
                        </div>
                    </div>
                </form>
