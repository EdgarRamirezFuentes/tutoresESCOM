...
<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
  ...
  <div class="container">
    ...
    <h6 class="border-bottom border-gray pb-2 mb-0 mt-5">Listado de administradores</h6>
    <?php 
        require './conexion.php';
        $conexion = conectar();
        if($conexion[0]) {
            $query = sprintf('SELECT * FROM adminRegistrados;');
                    ...
                    <div class="media text-muted pt-3">
                        <div class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
                            <div class="d-flex justify-content-between align-items-center w-100">
                                <strong class="d-block"> ID admin: '.$fila['idAdmin'].'</strong>
                            </div>
                            <span class="text-gray-dark"> Nombre: '.$fila['nombreAdmin'].'</span>
                            <span class="d-block"> Correo: '.$fila['correoAdmin'].'</span>
                        </div>
                    </div>
                ';
            }
