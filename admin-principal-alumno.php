...
<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
  ...
  <main role="main" class="container-fluid text-center">
    <h1 class="mb-5">Menú de alumnos</h1>
    <div class="row">
        <div class="col-sm-6 mt-5 text-center">
            <a href="./show-admin-alumno.php" class="btn btn-primary">Mostrar alumnos</a>
        </div>
        <div class="col-sm-6 mt-5 text-center">
            <a href="./delete-admin-alumno.php" class="btn btn-primary">Eliminar alumno</a>
        </div>
        <div class="col-sm-6 mt-5 text-center">
            <a href="./search-admin-alumno.php" class="btn btn-primary">Buscar alumno</a>
        </div>
    </div>
  </main>
</body>
