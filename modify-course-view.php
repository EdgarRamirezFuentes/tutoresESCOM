...
<body class="bg-light">
  <div class="container">
    ...
    <div class="col-md-12 order-md-1">
      ...
      <form class="needs-validation" method="post" action="./data-modify-course-view.php" novalidate>
        <div class="row">
            <div class="col-md-12 mb-3">
                <label>Selecciona el curso a modificar</label>
                <div class="container">
                <div class="row">    
            ...
            <div class="mt-3 mb-3 col-sm-12">
              <button class="btn btn-primary btn-lg btn-block mb-3" type="submit">Buscar curso</button>
