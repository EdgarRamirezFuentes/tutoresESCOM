...
<body class="text-center">
  <div class="container">
    <div class="row">
      ...
      <div class="col-sm-6">
      <a href="./signin-tutor.php"><button class="btn btn-lg btn-primary btn-block" name = "submitbtn" type="submit">Iniciar sesión como tutor</button></a>
      </div>
    </div>
    <form class="form-signin col-sm-12" action="signin-alumno.php" method="POST">
    <img class="mb-4" src="" alt="" width="72" height="72">
    <h1 class="h3 mb-3 font-weight-normal">Bienvenido alumno</h1>
    ...
    <a href="./signup-alumno.php"><p class="mt-5 mb-3 text-muted">Crear cuenta</p></a>
