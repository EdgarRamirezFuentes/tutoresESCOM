...
<body class="bg-light">
  <div class="container">
    ...
    <div class="col-md-12 order-md-1">
      <h4 class="mb-3">Datos del curso a eliminar</h4>
      <form class="needs-validation" method="post" action="./delete-tutor-course.php" novalidate>
        <div class="row">
            <div class="col-md-12 mb-3">
                <label>Selecciona el curso a eliminar</label>
                <div class="container">
                <div class="row">    
            ...
            <div class="mt-3 mb-3 col-sm-12">
              <button class="btn btn-primary btn-lg btn-block mb-3" type="submit">Eliminar curso</button>
