...
<head>
  ...
  <title>Página principal tutor</title>
...
<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
  ...
  <main role="main" class="container-fluid text-center">
    <h1 class="mb-5">Menú de tutores</h1>
    <div class="row">
        <div class="col-sm-6 mt-5 text-center">
            <a href="./show-admin-tutor.php" class="btn btn-primary">Mostrar tutores</a>
        </div>
        <div class="col-sm-6 mt-5 text-center">
            <a href="./delete-admin-tutor.php" class="btn btn-primary">Eliminar tutores</a>
        </div>
        <div class="col-sm-6 mt-5 text-center">
            <a href="./search-admin-tutor.php" class="btn btn-primary">Buscar tutor</a>
        </div>
    </div>
  </main>
</body>
