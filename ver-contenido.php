...
<head>
  ...
  <title><?php echo $_POST['nombreContenido']?></title>
...
<body class="bg-light">
  <div class="container">
    ...
    <?php session_start(); $path = './tutor/'.$_SESSION['idUsuario'].'/curso/'.str_replace(" ", "_", $_POST['nombreCurso']).'/'.str_replace(" ", "_", $_POST['nombreContenido']).'.mp4';?>
<h1><?php  echo $_POST['nombreContenido'] ?></h1>
