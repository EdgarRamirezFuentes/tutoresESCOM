...
<body class="bg-light">
  <div class="container">
    <div class="py-5 text-center">
      <h2>Formulario de registro del tutor</h2>
    </div>
    <div class="col-md-12 order-md-1">
      <h4 class="mb-3">Datos del tutor</h4>
      <form class="needs-validation" enctype="multipart/form-data" method="post" action="./signup-tutor.php" novalidate>
        <div class="row">
